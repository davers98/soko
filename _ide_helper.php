 ...
 */
    ...
    namespace Illuminate\Support\Facades {
        ...
        use Illuminate\View\Compilers\BladeCompiler as BladeCompilerAlias;
     ...
     */ 
        ...
        {
                        /** @var BladeCompilerAlias $instance */
        ...
        {
                        return BladeCompilerAlias::render($string, $data, $deleteCachedView);
        }
                    /**
        ...
        {
                        return BladeCompilerAlias::renderComponent($component);
        }
                    /**
        ...
        {
                        return BladeCompilerAlias::newComponentHash($component);
        }
                    /**
        ...
        {
                        return BladeCompilerAlias::compileClassComponentOpening($component, $alias, $data, $hash);
        }
                    /**
        ...
        {
                        return BladeCompilerAlias::sanitizeComponentAttribute($value);
        }
                    /**
